      ...
      <div className=" mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-3xl space-y-6 mb-14">
          ...
          <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
            ...
            networks like Radio Mirchi, Red FM, Radio City, Big FM, and Fever FM,
            alongside public broadcaster All India Radio (AIR) channels such as
            Vividh Bharati, FM Gold, and FM Rainbow.
          </p>
